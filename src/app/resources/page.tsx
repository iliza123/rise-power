...
function SectionEyebrow({
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <p
        className={`text-base font-semibold tracking-[0.14em] uppercase sm:text-[0.9375rem] ${onDark ? "text-white" : ""}`}
        style={{ color }}
      >
        {children}
      </p>
              ...
              {systems.map((system, index) => (
                ...
                >
                  ...
                  <div className="absolute inset-x-0 bottom-0 p-5 sm:p-6">
                    ...
                    <span className="mt-4 inline-flex items-center gap-2 text-sm font-semibold tracking-[0.1em] text-white uppercase">
                      View Specs
