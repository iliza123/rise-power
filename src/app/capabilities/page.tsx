    ...
    >
      ...
      >
        <div className="flex items-center gap-3.5">
          ...
          />
          <p className="text-sm font-semibold tracking-[0.22em] text-[#8a9186] uppercase">
            {tab.eyebrow}
          </p>
        </div>
            ...
            >
              {performanceMetrics.gauges.map((gauge, index) => {
                ...
                return (
                  ...
                  >
                    <span className="font-display text-sm font-semibold tracking-[0.28em] text-[#8a9186] uppercase transition-colors duration-500 group-hover:text-[#6e7f42]">
