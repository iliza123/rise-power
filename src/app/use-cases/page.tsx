    ...
    <article className="group flex h-full flex-col overflow-hidden rounded-xl border border-[#e0e3dd] bg-white transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_18px_45px_rgba(20,30,20,0.08)]">
      ...
      <div className="flex flex-1 flex-col p-6 sm:p-7">
        ...
        <div className="mt-auto pt-7">
          <a
            href={product.href}
            className="inline-flex items-center gap-4 text-sm font-bold tracking-[0.08em] text-[#20251f] uppercase"
          >
            ...
            >
              <div className="flex h-full flex-col p-7 sm:p-9 lg:p-11">
                ...
                <div className="mt-auto border-t border-[#e1e3de] pt-7">
                  <p className="text-center text-base font-semibold tracking-[0.16em] text-[#8a9089] uppercase">
                    Featured Products
                  </p>
        ...
        <div className="relative mx-auto max-w-[1440px] px-6 lg:px-10">
          ...
          {/* <Reveal variant="fade" delay={300}>
            <div className="mt-10 flex justify-center">
              <a
                href="/products"
                className="group inline-flex min-h-12 items-center justify-center gap-2 rounded-md px-9 text-sm font-bold tracking-[0.1em] text-white uppercase transition-opacity hover:opacity-90"
