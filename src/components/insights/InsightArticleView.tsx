      ...
      return (
        <Reveal variant="fade" delay={Math.min(index * 40, 200)}>
          ...
          >
            ...
            {block.attribution ? (
              <cite className="mt-4 block text-sm not-italic tracking-[0.16em] text-[#626a63] uppercase">
                {block.attribution}
              </cite>
            ) : null}
          </blockquote>
      ...
      return (
        <Reveal variant="fade" delay={Math.min(index * 40, 200)}>
          <figure className="my-10 sm:my-12 sm:-mx-4 lg:-mx-8">
            ...
            {block.caption ? (
              <figcaption className="mt-3 text-sm tracking-[0.12em] text-[#626a63] uppercase">
                {block.caption}
              </figcaption>
            ) : null}
          </figure>
    ...
    <article className="bg-[#fbfaf7] text-[#101820]">
      ...
      >
        <div className="hero-animate-copy w-full text-left">
          ...
          <p className="mt-5 border-t border-white/20 pt-4 text-sm tracking-[0.16em] text-white/70 uppercase">
            {article.readTime}
          </p>
              ...
              {related.map((item, index) => (
                <Reveal key={item.slug} variant="up" delay={index * 80}>
                  ...
                  >
                    ...
                    <p
                      className="mt-5 text-sm font-semibold tracking-[0.16em] uppercase"
                      style={{ color: MUTED }}
                    >
