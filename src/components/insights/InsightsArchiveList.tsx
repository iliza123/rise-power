      ...
      {hasMore ? (
        ...
        >
          <button
            ...
            disabled={isLoading}
            className="inline-flex min-h-12 items-center justify-center gap-2.5 rounded-sm border px-8 text-sm font-semibold tracking-[0.14em] uppercase transition-colors hover:bg-[#f3f2ed] disabled:cursor-wait disabled:opacity-70"
        ...
        <p
          className="pt-8 text-center text-sm font-semibold tracking-[0.16em] uppercase"
          style={{ color: muted }}
        >
